---
description: "Help debug issues by investigating logs, database state, and git history"
argument-hint: "[plan-or-ticket-file]"
---
...
When invoked with {{CONTEXT_FILE}} provided:
```
I'll help debug issues with {{CONTEXT_FILE}}. Let me understand the current state.
...
1. **Read {{CONTEXT_FILE}} if provided**:
